                    ...
                    <div class="sidebar-content js-simplebar">
                        ...
                        <ul class="sidebar-nav">
                            <li class="sidebar-header" style="font-size: 18px;">
                                <a href="{{route('dashboard.startup',$startup->token)}}">
                                    <span>
                                        Dashboard
                                    </span>
                                </a>
                            ...
                            <li class="sidebar-header" style="font-size: 18px;">
                                <a href="{{route('mystartup',$startup->token)}}">
                                    <span>
                                        Apropos de mon Startup 
                                    </span>
                                </a>
                            </li>

                            <li class="sidebar-header" style="font-size: 18px;">
                                <a href="{{route('services.startup',$startup->token)}}">
                                    <span>
                                        Mes Services
                                    </span>
                                </a>
